...
STAGES: List[Dict[str, Any]] = [
    ...
    {"id": "mainstream_physics",   "tab": "theoryTour",        "level": "mainstream",
     "concept_ids": ["holographic-principle", "celestial-holography", "rovelli-rqm",
                     "bell-nonlocality", "qec-holography"]},
    ...
    {"id": "oph_core",             "tab": "concepts",          "level": "speculative",
     "concept_ids": ["oph-observer-patch", "oph-self-simulating", "oph-consistency",
                     "oph-entropy-area"]},
    {"id": "oph_mechanism",        "tab": "ophMechanics",      "level": "speculative",
     "concept_ids": ["oph-overlap-consensus", "oph-fixed-point", "oph-error-correction",
                     "oph-entanglement", "oph-maxent", "oph-standard-model",
                     "oph-relativity", "oph-darwin"]},
    {"id": "philosophy",           "tab": "substrateQuestion", "level": "philosophy",
     "concept_ids": ["bostrom-simulation", "oph-metaphysics"]},
