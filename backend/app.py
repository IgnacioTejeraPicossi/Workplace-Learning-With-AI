...
# Red Cross Web QA Agent router (Agent #9 — Item Agents, 1.18.x)
try:
...
# Humanizing AI Agent router (Agent #10 — Item Agents)
try:
    from backend.routers.humanizing_ai import router as humanizing_ai_router
    app.include_router(humanizing_ai_router, tags=["Humanizing AI"])
    print("✅ Humanizing AI router included successfully")
except Exception as e:
...
# Maestro Chino IA router (Future Item Agents — next to Japanese Sensei)
try:
    from backend.routers.chinese_teacher import router as chinese_teacher_router
    app.include_router(chinese_teacher_router, tags=["Maestro Chino IA"])
    print("✅ Chinese Teacher router included successfully")
except Exception as e:
...
# Norsk Mester AI router (Language Agents group)
try:
    from backend.routers.norwegian_mentor import router as norwegian_mentor_router
    app.include_router(norwegian_mentor_router, tags=["Norsk Mester AI"])
    print("✅ Norwegian Mentor router included successfully")
except Exception as e:
