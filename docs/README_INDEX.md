...
- Architecture
  ...
  - [Agent Bridge + OutSystems/n8n](./architecture.md#agent-bridge)
- Deployment
  - [Backend startup](./deployment.md#backend-startup)
  - [Environment variables](./deployment.md#environment-variables)
  - [Docker/n8n notes](./n8n.md#n8n-webhook-setup)
- Agents
  - [AI Compliance Agent](./agents.md#ai-compliance-agent)
  - [AI Productivity Agent](./agents.md#ai-productivity-agent)
...
- Modules
  ...
  - [Red Cross Web QA Agent](./README_FULL.md#red-cross-web-qa-agent) - 24/7 QA copilot for rodekors.no (Enonic XP + NextJS + Designsystemet) — 20 tabs, 37 routes + 10 Phase H method bindings (Phase A+B+C+D+F+G+H: Sev/Kat dual severity, Sprint Report, DPIA / DoD / Resilience / UAT / Risk Matrix, k6 + Loadster dual load testing, Storybook + Postman + GraphQL introspection, NVDA + WAVE accessibility, **Phase H · Pack 2 — Sikkerhet og personvern workbench with stable backend contracts, persistence, finding workflow open/accepted_risk/fixed/verified preserved across re-scans, scan history with trend arrows, structured DPIA editor**)
  ...
  - [Humanizing AI Agent](./HUMANIZING_AI_README.md) - 7-tab ethical AI module: Humanize (with side-by-side diff) · Prompt Humanitas · Test Humanitas · **Model Comparison** · **Humanity Report** · **Gateway Filter** (transversal layer any module can call) · History (with detail modal). 26 dilemmas, C1–C5 rubric, F1–F3 pressure tests. 10 endpoints. Fully multilingual EN/ES/NO including dilemma texts
...
- Admin & Dev
  ...
  - [Feature Roadmap](./admin-dev.md#feature-roadmap)
