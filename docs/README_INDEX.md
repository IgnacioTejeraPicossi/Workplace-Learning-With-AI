...
- Modules
  ...
  - [Humanizing AI Agent](./HUMANIZING_AI_README.md) - 6-tab ethical AI module: Humanize · Prompt Humanitas · Test Humanitas · **Model Comparison** · **Humanity Report** · History (with detail modal). 26 dilemmas, C1–C5 rubric, F1–F3 pressure tests. 9 endpoints. Fully multilingual EN/ES/NO including dilemma texts
