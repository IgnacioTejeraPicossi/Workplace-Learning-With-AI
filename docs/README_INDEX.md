...
- Modules
  ...
  - [Red Cross Web QA Agent](./README_FULL.md#red-cross-web-qa-agent) - 24/7 QA copilot for rodekors.no (Enonic XP + NextJS + Designsystemet) — 20 tabs, 37 endpoints (Phase A+B+C+D+F+G: Sev/Kat dual severity, Sprint Report, DPIA / DoD / Resilience / UAT / Risk Matrix, k6 + Loadster dual load testing, Storybook + Postman + GraphQL introspection, **NVDA screen-reader script generator + WAVE (WebAIM) audit inside the Universell utforming-pilot tab**)
