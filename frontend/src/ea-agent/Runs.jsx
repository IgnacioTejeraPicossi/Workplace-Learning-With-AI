    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Execution history with attestation hashes
          </p>
        </div>
        <button
          onClick={loadRuns}
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center text-gray-500">
            No runs found. Try sending a sample insight from the Insights tab.
          </div>
        ) : (
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-900">
              Trust Receipts (Attestation Hashes)
            </h3>
            <p className="text-sm text-blue-700 mt-1">
              Each run includes a SHA-256 attestation hash computed from the
              bundle and artifacts. This provides an immutable audit trail for
