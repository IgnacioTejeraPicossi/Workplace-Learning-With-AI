...
import enSelfCorrectingLoopModule from './locales/en/selfCorrectingLoopModule.json';
import noSelfCorrectingLoopModule from './locales/no/selfCorrectingLoopModule.json';
import esSelfCorrectingLoopModule from './locales/es/selfCorrectingLoopModule.json';
...
import enAndresRobotModule from './locales/en/andresRobotModule.json';
import noAndresRobotModule from './locales/no/andresRobotModule.json';
import esAndresRobotModule from './locales/es/andresRobotModule.json';
...
import enHumanizingAiModule from './locales/en/humanizingAiModule.json';
import noHumanizingAiModule from './locales/no/humanizingAiModule.json';
import esHumanizingAiModule from './locales/es/humanizingAiModule.json';
import enJapaneseSenseiModule from './locales/en/japaneseSenseiModule.json';
import noJapaneseSenseiModule from './locales/no/japaneseSenseiModule.json';
import esJapaneseSenseiModule from './locales/es/japaneseSenseiModule.json';
import enChineseTeacherModule from './locales/en/chineseTeacherModule.json';
import noChineseTeacherModule from './locales/no/chineseTeacherModule.json';
import esChineseTeacherModule from './locales/es/chineseTeacherModule.json';
import enKoreanTeacherModule from './locales/en/koreanTeacherModule.json';
import noKoreanTeacherModule from './locales/no/koreanTeacherModule.json';
import esKoreanTeacherModule from './locales/es/koreanTeacherModule.json';
import enEnglishMentorModule from './locales/en/englishMentorModule.json';
import noEnglishMentorModule from './locales/no/englishMentorModule.json';
import esEnglishMentorModule from './locales/es/englishMentorModule.json';
import enNorwegianMentorModule from './locales/en/norwegianMentorModule.json';
import noNorwegianMentorModule from './locales/no/norwegianMentorModule.json';
import esNorwegianMentorModule from './locales/es/norwegianMentorModule.json';
import enSpanishTeacherModule from './locales/en/spanishTeacherModule.json';
import noSpanishTeacherModule from './locales/no/spanishTeacherModule.json';
import esSpanishTeacherModule from './locales/es/spanishTeacherModule.json';
