...
const SOURCES = [
  {
    ...
    items: [
      ...
      { name: "Semantic Scholar", url: "https://www.semanticscholar.org", desc: "AI-powered scholarly search (open)", access: "open" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "DOAJ", url: "https://doaj.org", desc: "Directory of Open Access Journals", access: "open" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Open Library", url: "https://openlibrary.org", desc: "Borrowable & public-domain eBooks", access: "open" },
      { name: "DOAB", url: "https://www.doabooks.org", desc: "Directory of Open Access Books", access: "open" },
