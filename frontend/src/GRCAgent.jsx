...
const GRCAgent = () => {
  ...
  const tabs = [
    { id: 'overview', label: t('grcAgentModule.tabOverview'), icon: '📊' },
    { id: 'findings', label: t('grcAgentModule.tabFindings'), icon: '🔍' },
    { id: 'actions', label: t('grcAgentModule.tabActions'), icon: '⚡' },
    { id: 'runs', label: t('grcAgentModule.tabRuns'), icon: '🏃' },
    { id: 'policies', label: t('grcAgentModule.tabPolicies'), icon: '📋' },
  ];
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              {t('grcAgentModule.title')}
            </h1>
            <p className="text-sm text-gray-600 mt-1">
              {t('grcAgentModule.tagline')}
            </p>
          </div>
        </div>
      </div>
