...
- Router: `backend/routers/red_cross_qa.py` — **41 routes** at `/api/red-cross-qa/*` (1.15.4 added `/ado/parse-pasted` + `/ado/paste-to-plan`; 1.15.7 added `/ado/fetch-sprint` + `/ado/format-item`)
